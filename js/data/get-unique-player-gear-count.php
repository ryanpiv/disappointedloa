...
$sql = "SELECT player, count(*) as num FROM disappointedloa.loot_history where response <> 'OS' OR response <> 'Pass' OR response <> 'xmog' group by player order by num desc";
